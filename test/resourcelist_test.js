...
var jsonFileAsObject = require('./asserts/jsonFileAsObject');

describe('resourcelist', function() {
	it("processes js files", function() {
		jsonFileAsObject.equal({
	...
	it("processes preload files", function() {
		jsonFileAsObject.equal({
			sActualFileSource: 'tmp/resourcelist/preload/resources.json',
			sExpectedFileSource: 'test/resourcelist/expected/preload/resources.json',
			sMessage: 'Resource list of preload file was not correctly created.'
		});
	});
